...
async function joinVoice(channelId){
  try{
    ...
    startSpeakDetect();socket.emit('join_voice',{channelId});currentVoiceId=channelId;
    playTone([523,659,784]);showToast('🎤 به ویس پیوستی');
  }catch(e){
    socket.emit('join_voice',{channelId});currentVoiceId=channelId;showToast('⚠️ بدون میکروفون');
  }
}
